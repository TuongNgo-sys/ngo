...
# -----------------------
# Ghi chú thêm (unchanged)
# -----------------------
st.header(_("📝 Ghi chú", "📝 Notes"))
st.markdown(_("Hệ thống tưới dựa trên dữ liệu cảm biến, dự báo thời tiết và khung giờ tưới đã được cấu hình.", "The irrigation system is based on sensor data, weather forecast and configured watering schedule."))
